...
const MenuSection: React.FC = () => {
  ...
  const menuItems = [
    ...
    {
      image: "https://oyc9u5lfcg.ufs.sh/f/lRAiGHfLmtpEpYzbDMSmV2SIraKe0WUujA76wYsQtqB31Dkx",
    ...
    {
      image: "https://oyc9u5lfcg.ufs.sh/f/lRAiGHfLmtpEG3FmdqypFArUYvkTyIa8314ueMEzB9KNQtco",
    ...
    {
      image: "https://oyc9u5lfcg.ufs.sh/f/lRAiGHfLmtpEzcGcMqt9fOESayYXKqrsZjCxLMPGJUe3N7F5",
